...
public interface DealerShipService {
     ...
     */
    DealerShipModel upsertDealserShip(DealerShipModel dealerShipModel) throws DealershipServiceException;
     ...
     */
    List<DealerShipModel> getDealerShips(String clientId);
