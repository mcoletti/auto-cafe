...
public class VehicleEndPoint {
    ...
    @ApiOperation(value = "Get a Vehicle Model Object based of VehicleId and ClientId",
            response = VehicleDetailsModel.class,
    ...
    public ResponseEntity getVehicle(@RequestParam(value = "vehicleId") String vehicleId, @RequestParam(value = "clientId") String clientId) {
        ...
        try {
            ...
            if (vehicleId != null) {
                ...
                VehicleDetailsModel model = vehicleService.getVehicleDetailsModel(vehicleId, clientId);
    ...
    @ApiOperation(value = "Get an Array of the Client Vehicles",
            response = ClientVehiclesCollection.class,
            responseContainer = "ClientVehiclesCollection")
    public ResponseEntity getClientVehicles(@PathVariable(value = "clientId") String clientId) {
        log.debug("Getting the ClientVehicles Collection for Client Id: {}", clientId);
        try {
            if (clientId != null) {
                ClientVehiclesCollection clientVehiclesCollection = vehicleService.getClientVehicles(clientId);
